...
* Everytime i try to get an API-KEY from the New York Times API, the key work fine on my browser with the appropriate URL. But when i put this URL in the code,
	it never work. I spent most the time to find a good API-KEY. The message you have in the log error is UNAUTORISE.
	
* My computer don't want to load the emulator. Anytime i have to run my apps , i have to use my android phone. So it's very difficult to do the gif file video.
